...
// include_once('advanced/ajax-search.php');
...
function wpeStyles()
{
  ...
  wp_register_style('wpeasy-style', get_template_directory_uri() . '/css/main.css', array(), '1.7', 'all');
...
<<?php echo $tag ?> <?php comment_class(empty($args['has_children']) ? '' : 'parent') ?>
  ...
  $breadcrums_class = 'breadcrumbs col-12';
  ...
  echo '<ul id="' . $breadcrums_id . '" class="' . $breadcrums_class . '">';
    ...
    echo '<li class="item-current item-current-' . get_query_var('paged') . '"><span
        class="bread-current bread-current-' . get_query_var('paged') . '" title="Page ' . get_query_var('paged') . '">'
        . __('Page') . ' ' . get_query_var('paged') . '</span></li>';
    } else if (is_search()) {
  ...
  add_action('init', 'register_cpts_university');
  function register_cpts_university()
  {
  /**
  ...
  */
  ...
  $labels = array(
  'name' => __('Universities', 'wpeasy'),
  'singular_name' => __('University', 'wpeasy'),
  ...
  */
  ...
  $labels = array(
  'name' => __('Services', 'wpeasy'),
  'singular_name' => __('Service', 'wpeasy'),
  'add_new' => __('Add', 'wpeasy'),
  'add_new_item' => __('Add', 'wpeasy'),
  'edit' => __('Edit', 'wpeasy'),
  'edit_item' => __('Edit', 'wpeasy'),
  ...
  */
  ...
  // echo $args;
  // wp_send_json($args);
  wp_send_json_success($args['areas']);
  die();
